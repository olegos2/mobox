...
## Налаштування
### Змінні dynarec в Box86 и Box64
Є двоє перемикаючих меню для модифікації змінних dynarec у меню налаштуваннях mobox.
...
розширення fallback використано лише коли розширення x11 не може бути виявлено самостійно.
...
* Рекомендовано пристрії зі Snapdragon з Adreno 6xx або Adreno 725-740 для отримання кращої продуктивності і сумісності з Turnip+DXVK.
### Root
* Root не потрібен.
...
```
* У деяких пристроїв можуть бути проблеми із зависаннями створення префіксу при встановленні PhysX, у такому випадку змініть налаштування у меню `Compatibility settings`
